...
const EXTENDED_ACTIVITY_CATALOG: ActivityProfile[] = [
  ...
  { id: 'workout', title: 'Workout', description: 'Use a supportive energy window for training, exercise, or a gym session.', category: 'WORKOUT', recommendedWindowTypes: ['ABHIJIT', 'NEUTRAL'], acceptableWindowTypes: ['GULIKA', 'BRAHMA'], avoidWindowTypes: ['RAHU_KALAM', 'YAMA'], significance: 'HIGH', requiresFreshStart: false, aliases: ['workout', 'work out', 'exercise', 'gym', 'training', 'run', 'lifting', 'heavy workout'], elementAffinity: 'FIRE', icon: '🏋️' },
