...
check('97. scope: no Home / UI / trigger / auto-acceptance wiring anywhere', ['apps/web/components/HomeTimeline.tsx', 'apps/web/lib/homeCompletion.ts', 'apps/web/lib/homeMove.ts'].every((f) => !/recompos/i.test(read(f))));
