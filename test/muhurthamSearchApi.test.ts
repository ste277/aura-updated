...
check('Unknown activityId is rejected', buildMuhurthamSearchRequest({ activityId: 'griha-pravesh', dateRange: { start: '2026-09-01', end: '2026-09-05' } }, chennaiContext).ok === false);
