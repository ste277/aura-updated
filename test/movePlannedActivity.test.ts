...
check('3/69. 0038 is D2\'s only migration (F1 later added 0039_planned_activity_scheduling_mode): 39 migrations; 0038 present; exactly 0038 and 0039 follow 0037', migs.length === 39 && migs.includes('0038_planned_activity_move_lineage') && migs.filter((d) => d > '0037_planned_activity_skipped_at').join() === '0038_planned_activity_move_lineage,0039_planned_activity_scheduling_mode');
